...
const xpPercentage = 75; // e.g., 68% to next level
  ...
  return (
    <div className="flex flex-col p-4 gap-4">
      ...
      <div className="grid grid-cols-5 gap-4">
        {/* XP Bar (2/3) */}
        <div className="flex flex-col items-start justify-center col-span-3 bg-white rounded-lg p-4 shadow-md">
          <h1 className="text-xl mb-2">
            Tier:{" "}
            <span className="font-bold" style={{ color: color || "#999" }}>
              {userTier || "Loading..."}
            </span>
          </h1>
          <p className="text-sm mb-2">XP Progress</p>
          <div className="w-full bg-gray-200 rounded-full h-4 relative">
            <div
              className={`bg-[${color}] h-4 rounded-full transition-all duration-500`}
              style={{
                width: `${xpPercentage}%`,
        ...
        {/* Badge (1/3) */}
        <div className="flex items-center justify-center col-span-2 bg-white rounded-lg shadow-md">
          {badgePath && (
            <Image src={badgePath} alt="Badge" width={120} height={120} />
          )}
        </div>
      </div>
